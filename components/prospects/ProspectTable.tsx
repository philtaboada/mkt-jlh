...
import { Prospect, ProspectProducts } from '@/lib/types/prospects';
import { DataTable } from '../shared/DataTable';
import { LeadEntityTypeLabels, LeadProductTypeLabels } from '@/lib/constants/leadConstants';
import { formatDate, formatDateTime } from '@/lib/utils/covertDate';
import { Badge } from '@/components/ui/badge';
import { SeaceDataTypes } from '@/lib/enums/seace';
            ...
            {value.map((prod) => (
              ...
              >
                {prod.type === LeadProductTypeEnum.SEGUROS
                  ? prod.insurance_type || LeadProductTypeLabels[prod.type] || prod.type
                  : LeadProductTypeLabels[prod.type] || prod.type}
              </Badge>
            ))}
          </div>
        );
