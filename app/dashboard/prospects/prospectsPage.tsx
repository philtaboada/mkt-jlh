...
import { useGetProspects } from '@/lib/hooks/useProspect';
import ProspectTable from '@/components/prospects/ProspectTable';
import { FilterProspect, GetProspectsParams } from '@/components/prospects/FilterProspect';
...
export function ProspectPageClient() {
  ...
  const onPageChange = (pageIndex: number, pageSize: number) => {
    // Implement pagination change logic here
  };
