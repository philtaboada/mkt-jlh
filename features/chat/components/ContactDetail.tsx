...
import { Mail, Phone, Smartphone, Calendar, Link2, X } from 'lucide-react';
        ...
        <div className="p-4 space-y-6">
          ...
          <div className="text-center border-b border-border pb-6">
            <Avatar className="h-20 w-20 mx-auto mb-4">
              ...
              <AvatarFallback className="text-lg">{contact.name?.charAt(0) || 'C'}</AvatarFallback>
            </Avatar>
            ...
            >
              <span
                className={cn('text-xs font-medium', statusColors[contact.status || 'lead'].text)}
              >
          ...
          <div className="space-y-4">
            ...
            {contact.fb_id && (
              <div>
                <label className="text-xs font-semibold text-muted-foreground">Facebook ID</label>
                <div className="flex items-center gap-2 mt-2">
            ...
            {contact.ig_id && (
              <div>
                <label className="text-xs font-semibold text-muted-foreground">Instagram ID</label>
                <div className="flex items-center gap-2 mt-2">
                  <Link2 className="w-4 h-4 text-muted-foreground" />
